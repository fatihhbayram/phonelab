...
// /cihazini-sat — Cihaz Alım (Buyback) sihirbazı sayfası.
// Slim sayfa-yerel header (logo → ana sayfa, tema toggle, WhatsApp) + BuybackWizard + mini footer.
// Ana navdaki hash-anchor'lar bu sayfada anlamsız olduğundan Nav yerine yerel başlık kullanılır.
    ...
    <div className="bw-page">
      ...
      <section className="bw-head">
        <div className="bw-head-inner">
          ...
          <h1 className="bw-title">Apple cihazınız için anında teklif alın</h1>
          <p className="bw-lead">
            Birkaç adımda modelinizi ve durumunu seçin; tahmini alım teklifinizi anında görün,
            ardından WhatsApp üzerinden hızlıca tamamlayalım.
          </p>
        </div>
      </section>
